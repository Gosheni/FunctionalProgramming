...
let test_iota1' _ = assert_equal (iota1' 6) [ 6; 5; 4; 3; 2; 1 ]
let test_iota2' _ = assert_equal (iota2' 5) [ 1; 2; 3; 4; 5 ]

let test_factors' _ =
  assert_equal (factors' 10) [ 1; 2; 5; 10 ];
  assert_equal (factors' 12) [ 1; 2; 3; 4; 6; 12 ];
  assert_equal (factors' 28) [ 1; 2; 4; 7; 14; 28 ]
...
let test_is_prime _ =
  ...
  assert_equal (is_prime 43) true;
  assert_equal (is_prime 67) true
...
let test_prime_factor_with_greatest_multiplicity _ =
  ...
  assert_equal (prime_factor_with_greatest_multiplicity 216) 3;
  assert_equal (prime_factor_with_greatest_multiplicity 210) 7;
...
let tower_board_ill_formed_3x3 = [ [ 1; 2; 3];
                                   [ 3; 2; 1];
                                   [ 2; 3; 1] ]
let stower_board_example_3x3 = [ [ 2; 1; 3 ]; 
                                [ 3; 2; 1 ]; 
                                [ 1; 3; 2 ] ]
let stower_board_example_transposed_3x3 = [ [ 2; 3; 1 ];
                                           [ 1; 2; 3 ];
                                           [ 3; 1; 2 ] ]
let stower_board_example_reflected_3x3 = [ [ 3; 1; 2 ];
                                          [ 1; 2; 3 ];
                                          [ 2; 3; 1 ] ]
...
let test_square_size _ = 
  ...
  assert_equal (square_size stower_board_example_3x3) (Ok 3);
...
let test_well_formed_grid _ =
  ...
  assert_equal (well_formed_grid stower_board_example_3x3) true;
...
let test_verify_left_clues _ =
  ...
  assert_equal (verify_left_clues stower_board_example_3x3 [ 2; 1; 2]) true;
...
let test_transpose _ =
  ...
  assert_equal (transpose stower_board_example_3x3) stower_board_example_transposed_3x3;
...
let test_reflect_vertical_axis _ =
  ...
  assert_equal (reflect_vertical_axis stower_board_example_3x3) stower_board_example_reflected_3x3
...
let test_rotate_ccw _ =
  ...
  assert_equal
    (stower_board_example_3x3 |> rotate_ccw |> rotate_ccw |> rotate_ccw |> rotate_ccw)
    stower_board_example_3x3;
  assert_equal (rotate_ccw tower_board_example_3x3) [ [ 3; 2; 1 ]; [ 2; 1; 3 ]; [ 1; 3; 2 ] ];
  assert_equal (rotate_ccw stower_board_example_3x3) [ [ 3; 1; 2 ]; [ 1; 2; 3 ]; [ 2; 3; 1 ] ]
...
let svalid_counts_example_3x3 = [ [ 2; 1; 2 ]; [ 1; 3; 2 ]; [ 2; 3; 1 ]; [ 2; 1; 2 ] ]
...
let test_verify_towers_solution _ =
  ...
  assert_equal
    ...
    true;
  assert_equal
    (verify_towers_solution stower_board_example_3x3 svalid_counts_example_3x3)
    true;
  assert_equal
...
let part2_section3_tests =
  "Part 2 Section 3" >::: [
    ...
    "Reflect Vertical Axis" >:: test_reflect_vertical_axis;
